...
export default {
  ...
  data() {
    return {
      ...
      loginRules: {
        identifier: [{ required: true, message: '用户名必填', trigger: 'blur' },
          { pattern: /^admin$/, message: '请输入正确用户名', trigger: 'blur' }],
        password: [{ required: true, message: '密码必填', trigger: 'blur' }, { pattern: /^adminadmin$/, message: '请输入正确的密码', trigger: 'blur' }
        ]
      },
      loading: false,
